...
import { useGlobal } from "../context/GlobalContext"; // ← جديد
...
const TRANSLATIONS = {
  ...
  fr: {
    back: "Retour", bookNow: "Réserver", whatsapp: "WhatsApp",
    fromPrice: "À partir de", perPerson: "par personne", save: "Économisez",
    selectDate: "Choisir la date", adults: "Adultes", children: "Enfants",
    adult: "Adulte", child: "Enfant", total: "Total",
    bookTour: "✦  Réserver cette visite", bookWhatsapp: "💬  Réserver via WhatsApp",
    securePayment: "Paiement sécurisé", freeCancel: "Annulation gratuite",
    instantConfirm: "Confirmation immédiate", bestPrice: "Meilleur prix",
    overview: "Aperçu", includes: "Inclus", itinerary: "Itinéraire", reviews: "Avis",
    tourHighlights: "Points forts", duration: "Durée", groupSize: "Taille du groupe",
    difficulty: "Difficulté", minAge: "Âge minimum", allAges: "Tous âges", years: "+ ans",
    meetingPoint: "📍 Point de rendez-vous", cancellation: "✓ Politique d'annulation",
    whatsIncluded: "Ce qui est inclus", notIncluded: "Non inclus",
    detailedItinerary: "Itinéraire détaillé", outOf: "sur 5.0",
    guideQuality: "Qualité du guide", valueForMoney: "Rapport qualité-prix",
    organisation: "Organisation", experience: "Expérience", transport: "Transport",
    topRated: "✦ Mieux noté", tourNotFound: "VISITE INTROUVABLE",
    returnHome: "← Retour à l'accueil", youSave: "Vous économisez", today: "aujourd'hui",
    moreIn: "Plus à", viewAll: "Voir tout ›", youMayLove: "✦ Vous aimerez aussi",
    hotelPickup: "Transfert hôtel", included: "Inclus", entryTickets: "Billets d'entrée",
    languages: "Langues", multiDayPackage: "Forfait multi-jours",
    dayExperience: "Excursion d'une journée", egypt: "Égypte", maxPeople: "Max",
    people: "personnes", verifiedReviews: "avis vérifiés",
    privateLuxury: "Expériences privées de luxe", whatsappUs: "Contactez-nous",
    view: "Voir ›", pax: "pers.", bookNowEmoji: "🎫 Réserver", yousave: "🎉 Vous économisez $",
  },
  es: {
    back: "Volver", bookNow: "Reservar", whatsapp: "WhatsApp",
    fromPrice: "Desde", perPerson: "por persona", save: "Ahorra",
    selectDate: "Seleccionar fecha", adults: "Adultos", children: "Niños",
    adult: "Adulto", child: "Niño", total: "Total",
    bookTour: "✦  Reservar este tour", bookWhatsapp: "💬  Reservar por WhatsApp",
    securePayment: "Pago seguro", freeCancel: "Cancelación gratuita",
    instantConfirm: "Confirmación inmediata", bestPrice: "Mejor precio",
    overview: "Resumen", includes: "Incluye", itinerary: "Itinerario", reviews: "Opiniones",
    tourHighlights: "Aspectos destacados", duration: "Duración", groupSize: "Tamaño del grupo",
    difficulty: "Dificultad", minAge: "Edad mínima", allAges: "Todas las edades", years: "+ años",
    meetingPoint: "📍 Punto de encuentro", cancellation: "✓ Política de cancelación",
    whatsIncluded: "Qué está incluido", notIncluded: "No incluido",
    detailedItinerary: "Itinerario detallado", outOf: "de 5.0",
    guideQuality: "Calidad del guía", valueForMoney: "Relación calidad-precio",
    organisation: "Organización", experience: "Experiencia", transport: "Transporte",
    topRated: "✦ Mejor valorado", tourNotFound: "TOUR NO ENCONTRADO",
    returnHome: "← Volver al inicio", youSave: "Ahorras", today: "hoy",
    moreIn: "Más en", viewAll: "Ver todo ›", youMayLove: "✦ También te puede gustar",
    hotelPickup: "Recogida en hotel", included: "Incluido", entryTickets: "Entradas",
    languages: "Idiomas", multiDayPackage: "Paquete multi-día",
    dayExperience: "Excursión de un día", egypt: "Egipto", maxPeople: "Máx.",
    people: "personas", verifiedReviews: "opiniones verificadas",
    privateLuxury: "Experiencias privadas de lujo", whatsappUs: "Contáctenos",
    view: "Ver ›", pax: "pers.", bookNowEmoji: "🎫 Reservar", yousave: "🎉 Ahorras $",
  },
  it: {
    back: "Indietro", bookNow: "Prenota", whatsapp: "WhatsApp",
    fromPrice: "Da", perPerson: "per persona", save: "Risparmia",
    selectDate: "Seleziona data", adults: "Adulti", children: "Bambini",
    adult: "Adulto", child: "Bambino", total: "Totale",
    bookTour: "✦  Prenota questo tour", bookWhatsapp: "💬  Prenota via WhatsApp",
    securePayment: "Pagamento sicuro", freeCancel: "Cancellazione gratuita",
    instantConfirm: "Conferma immediata", bestPrice: "Miglior prezzo",
    overview: "Panoramica", includes: "Include", itinerary: "Itinerario", reviews: "Recensioni",
    tourHighlights: "Punti salienti", duration: "Durata", groupSize: "Dimensione gruppo",
    difficulty: "Difficoltà", minAge: "Età minima", allAges: "Tutte le età", years: "+ anni",
    meetingPoint: "📍 Punto d'incontro", cancellation: "✓ Politica di cancellazione",
    whatsIncluded: "Cosa è incluso", notIncluded: "Non incluso",
    detailedItinerary: "Itinerario dettagliato", outOf: "su 5.0",
    guideQuality: "Qualità guida", valueForMoney: "Rapporto qualità-prezzo",
    organisation: "Organizzazione", experience: "Esperienza", transport: "Trasporto",
    topRated: "✦ Più votato", tourNotFound: "TOUR NON TROVATO",
    returnHome: "← Torna alla home", youSave: "Risparmi", today: "oggi",
    moreIn: "Altro a", viewAll: "Vedi tutto ›", youMayLove: "✦ Potrebbe piacerti anche",
    hotelPickup: "Pickup hotel", included: "Incluso", entryTickets: "Biglietti d'ingresso",
    languages: "Lingue", multiDayPackage: "Pacchetto multi-giorno",
    dayExperience: "Escursione di un giorno", egypt: "Egitto", maxPeople: "Max",
    people: "persone", verifiedReviews: "recensioni verificate",
    privateLuxury: "Esperienze private di lusso", whatsappUs: "Contattaci",
    view: "Vedi ›", pax: "pers.", bookNowEmoji: "🎫 Prenota", yousave: "🎉 Risparmi $",
  },
  de: {
    back: "Zurück", bookNow: "Buchen", whatsapp: "WhatsApp",
    fromPrice: "Ab", perPerson: "pro Person", save: "Sparen",
    selectDate: "Reisedatum wählen", adults: "Erwachsene", children: "Kinder",
    adult: "Erwachsener", child: "Kind", total: "Gesamt",
    bookTour: "✦  Diese Tour buchen", bookWhatsapp: "💬  Via WhatsApp buchen",
    securePayment: "Sichre Zahlung", freeCancel: "Kostenlose Stornierung",
    instantConfirm: "Sofortbestätigung", bestPrice: "Bester Preis",
    overview: "Übersicht", includes: "Inklusive", itinerary: "Reiseplan", reviews: "Bewertungen",
    tourHighlights: "Tour-Highlights", duration: "Dauer", groupSize: "Gruppengröße",
    difficulty: "Schwierigkeit", minAge: "Mindestalter", allAges: "Alle Altersgruppen", years: "+ Jahre",
    meetingPoint: "📍 Treffpunkt", cancellation: "✓ Stornierungsbedingungen",
    whatsIncluded: "Was ist inbegriffen", notIncluded: "Nicht inbegriffen",
    detailedItinerary: "Detaillierter Reiseplan", outOf: "von 5.0",
    guideQuality: "Führerqualität", valueForMoney: "Preis-Leistungs-Verhältnis",
    organisation: "Organisation", experience: "Erlebnis", transport: "Transport",
    topRated: "✦ Bestbewertet", tourNotFound: "TOUR NICHT GEFUNDEN",
    returnHome: "← Zurück zur Startseite", youSave: "Sie sparen", today: "heute",
    moreIn: "Mehr in", viewAll: "Alle anzeigen ›", youMayLove: "✦ Das könnte Ihnen gefallen",
    hotelPickup: "Hotelabholung", included: "Inklusive", entryTickets: "Eintrittskarten",
    languages: "Sprachen", multiDayPackage: "Mehrtagespaket",
    dayExperience: "Tagesausflug", egypt: "Ägypten", maxPeople: "Max.",
    people: "Personen", verifiedReviews: "verifizierte Bewertungen",
    privateLuxury: "Private Luxuserlebnisse", whatsappUs: "Kontaktieren Sie uns",
    view: "Ansehen ›", pax: "Pers.", bookNowEmoji: "🎫 Buchen", yousave: "🎉 Sie sparen $",
  },
};

// خريطة: كود اللغة في GlobalContext → كود في TRANSLATIONS
const LANG_MAP = {
  en: "en", ar: "ar", fr: "fr", es: "es",
  it: "it", de: "de",
  // باقي اللغات هترجع انجليزي كـ fallback
  pt: "en", zh: "en", ja: "en", ru: "en",
  nl: "en", he: "ar", hi: "en", tr: "en",
  ko: "en", pl: "en",
};
...
const GlobalStyles = () => (
  <style>{`
    ...
    *,*::before,*::after{margin:0;padding:0;box-sizing:border-box}
    ...
    .tp-sticky-name{font-family:var(--ft);font-size:12px;color:var(--text);letter-spacing:.5px;flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
    .tp-sticky-price{font-family:var(--fd);font-size:18px;color:var(--gold);font-weight:700;white-space:nowrap}
    .tp-sticky-btn{background:linear-gradient(135deg,var(--gold),var(--gold-light));color:#0B0900;border:none;border-radius:6px;padding:8px 20px;font-family:var(--ft);font-size:9px;letter-spacing:2px;font-weight:700;cursor:pointer;text-transform:uppercase;white-space:nowrap}
    ...
    .tp-hero-bg{position:absolute;inset:0;background-size:cover;background-position:center;animation:kbz 14s ease-in-out infinite alternate}
    ...
    .tp-band{position:absolute;top:28%;left:0;right:0;z-index:3;height:44px;pointer-events:none;border-top:1px solid rgba(201,168,76,.15);border-bottom:1px solid rgba(201,168,76,.15);background:rgba(7,5,13,.28);display:flex;align-items:center;overflow:hidden}
    .tp-band-txt{font-family:var(--ft);font-size:10px;letter-spacing:7px;color:rgba(201,168,76,.4);white-space:nowrap;text-transform:uppercase;animation:marquee 28s linear infinite}
    ...
    .tp-hbadge{background:rgba(7,5,13,.85);backdrop-filter:blur(12px);border:1px solid var(--gold-border);border-radius:4px;padding:5px 12px;font-family:var(--ft);font-size:8px;letter-spacing:2px;color:var(--gold);text-transform:uppercase}
    ...
    .tp-act{width:38px;height:38px;border-radius:8px;background:rgba(7,5,13,.82);backdrop-filter:blur(10px);border:1px solid var(--gold-border);color:var(--gold);display:flex;align-items:center;justify-content:center;cursor:pointer;font-size:15px;transition:all .2s}
    .tp-thumbs{position:absolute;bottom:200px;right:28px;z-index:5;display:flex;flex-direction:column;gap:8px}
    .tp-thumb{width:72px;height:52px;border-radius:6px;overflow:hidden;border:2px solid transparent;cursor:pointer;opacity:.6;transition:all .25s}
    ...
    .tp-hero-ey{font-family:var(--ft);font-size:9px;letter-spacing:5px;color:var(--gold);text-transform:uppercase;margin-bottom:14px;display:flex;align-items:center;gap:12px}
    ...
    .tp-hmi{display:flex;align-items:center;gap:6px;font-family:var(--ft);font-size:9px;letter-spacing:1.5px;color:var(--text-dim);text-transform:uppercase}
    ...
    .tp-htop{background:var(--gold-dim);border:1px solid var(--gold-border);border-radius:4px;padding:3px 10px;font-family:var(--ft);font-size:8px;letter-spacing:2px;color:var(--gold);text-transform:uppercase}
    .tp-crumb{padding:12px 48px;background:var(--surface);border-bottom:1px solid var(--gold-border);display:flex;align-items:center;gap:8px;font-family:var(--ft);font-size:9px;letter-spacing:1.5px;color:var(--muted);position:relative;z-index:5}
    ...
    .tp-qbar{display:flex;background:var(--surface2);border-bottom:1px solid var(--gold-border);overflow-x:auto;position:relative;z-index:5}
    .tp-qi{flex:1;min-width:130px;padding:18px;display:flex;align-items:center;gap:11px;border-right:1px solid var(--gold-border);transition:background .2s}
    ...
    .tp-body{display:grid;grid-template-columns:1fr 380px;gap:48px;padding:56px 48px;align-items:start;position:relative;z-index:5;max-width:1400px;margin:0 auto}
    .tp-tabs{display:flex;border-bottom:1px solid var(--gold-border);margin-bottom:36px;overflow-x:auto}
    .tp-tab{background:transparent;border:none;border-bottom:2px solid transparent;color:var(--muted);font-family:var(--ft);font-size:9px;letter-spacing:2.5px;padding:14px 22px;cursor:pointer;text-transform:uppercase;margin-bottom:-1px;transition:all .2s;white-space:nowrap}
    ...
    .tp-main-title{font-family:var(--fd);font-size:clamp(20px,3vw,34px);color:var(--text);font-weight:700;line-height:1.2;margin-bottom:18px}
    ...
    .tp-top-tag{background:var(--gold-dim);border:1px solid var(--gold-border);border-radius:4px;padding:4px 12px;font-family:var(--ft);font-size:8px;letter-spacing:2px;color:var(--gold);text-transform:uppercase}
    .tp-body-txt{font-family:var(--fb);font-size:18px;color:var(--text-dim);line-height:1.85;margin-bottom:36px;font-weight:300}
    .tp-sec-h{font-family:var(--ft);font-size:10px;letter-spacing:3.5px;color:var(--gold);text-transform:uppercase;margin-bottom:18px;display:flex;align-items:center;gap:14px}
    ...
    .tp-hl{display:flex;align-items:flex-start;gap:13px;padding:12px 0;border-bottom:1px solid rgba(201,168,76,.06);transition:all .2s;border-radius:4px}
    ...
    .tp-icard{background:var(--surface2);border:1px solid var(--gold-border);border-radius:10px;padding:16px 18px;transition:all .2s}
    ...
    .tp-inc{display:flex;align-items:center;gap:12px;background:var(--surface2);border:1px solid var(--gold-border);border-radius:10px;padding:14px 16px;transition:all .2s}
    ...
    .tp-step-marker{width:48px;height:48px;border-radius:50%;background:var(--gold-dim);border:2px solid var(--gold);display:flex;align-items:center;justify-content:center;font-size:18px;box-shadow:0 0 20px rgba(201,168,76,.18);transition:all .3s;flex-shrink:0}
    ...
    .tp-stag{background:var(--gold-dim);border:1px solid var(--gold-border);border-radius:12px;padding:3px 10px;font-family:var(--ft);font-size:7px;letter-spacing:1.5px;color:rgba(201,168,76,.85);text-transform:uppercase}
    .tp-rev-sum{display:flex;gap:28px;align-items:center;background:var(--surface2);border:1px solid var(--gold-border);border-radius:14px;padding:28px;margin-bottom:28px}
    ...
    .tp-revc{background:var(--surface2);border:1px solid var(--gold-border);border-radius:12px;padding:22px 24px;transition:border-color .2s}
    .tp-revc:hover{border-color:rgba(201,168,76,.4)}
    .tp-rev-head{display:flex;align-items:center;gap:12px;margin-bottom:14px}
    .tp-rev-av{width:42px;height:42px;border-radius:50%;border:1px solid var(--gold-border);background:var(--gold-dim);display:flex;align-items:center;justify-content:center;font-size:20px;flex-shrink:0}
    ...
    .tp-widget{position:sticky;top:84px;background:var(--surface);border:1px solid var(--gold-border);border-radius:16px;overflow:hidden;box-shadow:0 24px 80px rgba(0,0,0,.6)}
    .tp-wh{background:linear-gradient(135deg,#B8902E 0%,var(--gold) 40%,var(--gold-light) 70%,#C9A84C 100%);padding:22px 24px;position:relative;overflow:hidden}
    ...
    .tp-wsave{display:inline-block;background:rgba(11,9,0,.15);border-radius:4px;padding:2px 8px;font-family:var(--ft);font-size:8px;letter-spacing:1px;color:rgba(11,9,0,.7);text-transform:uppercase;margin-left:8px}
    ...
    .tp-wfi{width:100%;background:rgba(255,255,255,.05);border:1px solid var(--gold-border);border-radius:8px;color:var(--text);padding:12px 14px;font-family:var(--fb);font-size:16px;outline:none;transition:border-color .2s;color-scheme:dark}
    .tp-wfi:focus{border-color:var(--gold)}
    .tp-wfrow{display:grid;grid-template-columns:1fr 1fr;gap:12px}
    .tp-wfs{width:100%;background:rgba(255,255,255,.05);border:1px solid var(--gold-border);border-radius:8px;color:var(--text);padding:12px 14px;font-family:var(--fb);font-size:15px;cursor:pointer;outline:none;transition:border-color .2s}
    .tp-bk{padding:14px 0;margin:16px 0;border-top:1px solid rgba(201,168,76,.1);border-bottom:1px solid rgba(201,168,76,.1)}
    .tp-bkr{display:flex;justify-content:space-between;align-items:center;margin-bottom:8px;font-family:var(--fb);font-size:15px;color:var(--muted)}
    .tp-bkr.tot{color:var(--text);padding-top:10px;margin-top:6px;border-top:1px solid rgba(201,168,76,.1);font-family:var(--ft);font-size:11px;letter-spacing:1px;text-transform:uppercase}
    .tp-bkr.tot .amt{color:var(--gold);font-family:var(--fd);font-size:22px;font-weight:700}
    .tp-bookbtn{width:100%;background:linear-gradient(135deg,var(--gold),var(--gold-light));color:#0B0900;border:none;border-radius:8px;padding:17px;font-family:var(--ft);font-weight:700;font-size:11px;letter-spacing:2.5px;text-transform:uppercase;cursor:pointer;margin-bottom:10px;box-shadow:0 6px 24px rgba(201,168,76,.32);transition:all .3s}
    .tp-bookbtn:hover{box-shadow:0 10px 36px rgba(201,168,76,.55);transform:translateY(-2px)}
    .tp-wabk{width:100%;background:#25D366;color:#fff;border:none;border-radius:8px;padding:14px;font-family:var(--ft);font-weight:700;font-size:10px;letter-spacing:2px;text-transform:uppercase;cursor:pointer;transition:all .2s;display:block;text-align:center;text-decoration:none}
    ...
    .tp-trust-i{flex:1;text-align:center;padding:0 5px;border-right:1px solid rgba(201,168,76,.1);font-family:var(--ft);font-size:7px;letter-spacing:1px;color:var(--muted);text-transform:uppercase;line-height:1.4}
    .tp-trust-i:last-child{border-right:none}
    .tp-trust-ic{font-size:15px;display:block;margin-bottom:4px;color:var(--gold)}
    .tp-save-pill{display:inline-flex;align-items:center;gap:6px;background:rgba(42,160,100,.12);border:1px solid rgba(42,160,100,.25);border-radius:20px;padding:5px 14px;margin-bottom:18px;font-family:var(--ft);font-size:9px;letter-spacing:1.5px;color:#4CAF82;text-transform:uppercase}
    .tp-wafloat{position:fixed;right:20px;bottom:76px;z-index:900;display:flex;align-items:center;gap:8px;background:#25D366;color:#fff;border-radius:30px;padding:11px 18px;text-decoration:none;font-family:var(--ft);font-weight:700;font-size:10px;letter-spacing:1px;text-transform:uppercase;box-shadow:0 6px 28px rgba(37,211,102,.45);transition:all .25s}
    .tp-scrolltop{position:fixed;right:20px;bottom:22px;z-index:900;width:40px;height:40px;border-radius:8px;background:var(--gold-dim);border:1px solid var(--gold);color:var(--gold);cursor:pointer;font-size:13px;display:flex;align-items:center;justify-content:center;transition:all .25s}
    .tp-loader{display:flex;flex-direction:column;align-items:center;justify-content:center;height:100vh;background:var(--obsidian);gap:20px}
...
//  BOOKING WIDGET
// ─────────────────────────────────────────────────────────────
function BookingWidget({ tour, onBook, t, lang, formatPrice }) {
      ...
      <div className="tp-wh">
        ...
        <div style={{ display:"flex", alignItems:"baseline", gap:8, flexWrap:"wrap" }}>
          ...
          {tour.price?.discounted && <>
            <span className="tp-wold">{formatPrice(originalPrice)}</span>
      ...
      <div className="tp-wb">
        ...
        <div className="tp-bk">
          <div className="tp-bkr">
            <span>{adults} {t.adult}{adults>1?"s":""} × {formatPrice(price)}</span>
            <span>{formatPrice(adultAmt)}</span>
          </div>
          {children > 0 && (
            <div className="tp-bkr">
              <span>{children} {children===1?t.child:t.children} × {formatPrice(price*.5)}</span>
              <span>{formatPrice(childAmt)}</span>
            </div>
          )}
          <div className="tp-bkr tot">
            <span>{t.total}</span>
            <span className="amt">{formatPrice(total)}</span>
          </div>
        </div>
        ...
        <div style={{ marginBottom:10 }}>
          <button className="tp-bookbtn" onClick={() => navigate(`/booking/${tour._id}`)}>
            {t.bookNowEmoji}
          </button>
        </div>
        ...
        <div className="tp-trust">
          {[["🔒",t.securePayment],["✓",t.freeCancel],["⚡",t.instantConfirm],["🏆",t.bestPrice]].map(([ic,label]) => (
            <div key={label} className="tp-trust-i">
              <span className="tp-trust-ic">{ic}</span>{label}
            </div>
          ))}
        </div>
      </div>
...
export default function TourPage() {
  ...
  // ← جلب اللغة والعملة من GlobalContext
  ...
  // ← تحويل كود اللغة من GlobalContext لكود TRANSLATIONS
  ...
  return (
    <div style={{ background:"var(--obsidian)",minHeight:"100vh",position:"relative" }}
      ...
      <div className={`tp-sticky${sticky?" on":""}`}>
        ...
        <span style={{ fontFamily:"var(--fb)",fontSize:13,color:"var(--muted)" }}>{score} ({reviews?.toLocaleString()})</span>
        <span className="tp-sticky-price">{t.fromPrice} {formatPrice(price)}</span>
      ...
      <nav className="tp-nav">
        <button className="tp-back" onClick={() => navigate(-1)}>← {t.back}</button>
      ...
      <section className="tp-hero">
        ...
        <div className="tp-band">
          <span className="tp-band-txt">𓂀 &nbsp; {tour.category} &nbsp; 𓃭 &nbsp; Golden Egypt Tours &nbsp; 𓆑 &nbsp; {tourTitle} &nbsp; 𓇋</span>
        </div>
        <div className="tp-hero-badges">
          {tour.freeCancellation && <span className="tp-hbadge new">{t.freeCancel}</span>}
          {tour.price?.discounted && <span className="tp-hbadge hot">{t.save} {Math.round((1-tour.price.discounted/tour.price.original)*100)}%</span>}
          <span className="tp-hbadge">{tour.category}</span>
        </div>
        <div className="tp-hero-acts">
          <button className="tp-act" onClick={() => navigator.share?.({ title:tourTitle,url:window.location.href })}>↗</button>
          <button className="tp-act" onClick={() => setFav(v=>!v)} style={{ color:fav?"#e55":"var(--gold)" }}>{fav?"♥":"♡"}</button>
        </div>
        <div className="tp-thumbs">
          {images.map((src,i) => (
            <div key={i} className={`tp-thumb${heroImg===i?" on":""}`} onClick={() => setHeroImg(i)}>
              <img src={src} alt={`View ${i+1}`} onError={e=>{e.target.src=`https://placehold.co/72x52/0C0A14/C9A84C?text=${i+1}`;}} />
            </div>
          ))}
        </div>
        <div className="tp-hero-cnt">
          <div className="tp-hero-ey">{tour.category} &nbsp;·&nbsp; {t.egypt}</div>
          <h1 className="tp-htitle">{tourTitle}</h1>
          <p className="tp-htagline">{tourDesc?.slice(0,120)}...</p>
          <div className="tp-hmeta">
            {[{i:"⏱",t2:tour.duration},{i:"👥",t2:`${tour.travellers?.toLocaleString()} ${t.pax}`},{i:"🗣️",t2:(tour.language||[]).slice(0,3).join(" · ")}].map((m,idx) => (
      ...
      <div className="tp-body">
        <div>
            ...
            {(tour.excludes||[]).length>0 && (
              <>
                ...
                <ul className="tp-exclist">
                  {tour.excludes.map((e,i) => <li key={i} className="tp-exc">{e}</li>)}
                </ul>
              </>
            )}
          </div>
          ...
          <div className={`tp-panel${tab==="itinerary"?" on":""}`}>
            ...
            {(tour.itinerary||[]).length>0 ? (
              ...
              <div style={{ fontFamily:"var(--fb)",color:"var(--muted)",fontSize:16,padding:"20px 0" }}>{tourDesc}</div>
            )}
          </div>
          ...
          <div className={`tp-panel${tab==="reviews"?" on":""}`}>
            <div className="tp-rev-sum">
              ...
              <div className="tp-rbars">
                {[{l:t.guideQuality,p:98},{l:t.valueForMoney,p:94},{l:t.organisation,p:96},{l:t.experience,p:99},{l:t.transport,p:93}].map(b => (
                  <div key={b.l} className="tp-rbar-row">
                    <span className="tp-rbar-l">{b.l}</span>
                    <div className="tp-rbar-track"><div className="tp-rbar-fill" style={{ width:`${b.p}%` }} /></div>
        ...
        {/* BOOKING WIDGET */}
        <aside>
          <BookingWidget tour={tour} onBook={handleBook} t={t} lang={lang} formatPrice={formatPrice} />
        </aside>
      </div>
