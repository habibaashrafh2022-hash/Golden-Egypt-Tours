...
const TR = {
  en:{
    ...
    pkgFrom:"From", pkgPerson:"/person", pkgView:"View Package →",
    pkgTitle:"Egypt Travel Packages", pkgSub:"Complete Journeys",
    exploreAll:"Explore All", packages:"Packages",
  },
  ar:{
    ...
    pkgFrom:"من", pkgPerson:"/شخص", pkgView:"عرض الباقة ←",
    pkgTitle:"باقات السفر إلى مصر", pkgSub:"رحلات متكاملة",
    exploreAll:"استعرض كل", packages:"الباقات",
  },
  es:{nav:{home:"Inicio",tours:"Tours",cruises:"Cruceros Nilo",hotels:"Hoteles",about:"Nosotros",contact:"Contacto"},heroTag:"Especialistas N°1 en Egipto desde 2009",title:"GOLDEN EGYPT",sub:"Tours & Expeditions",desc:"Cinco milenios de maravillas — un viaje extraordinario",searchPh:"Buscar destinos, tours, experiencias…",adv:"Búsqueda Avanzada",checkin:"Llegada",checkout:"Salida",guests:"Huéspedes",adults:"Adultos",children:"Niños",tourType:"Tipo de Tour",searchBtn:"Buscar Egipto",destTitle:"Explorar Egipto",destSub:"Diez destinos legendarios · Historias infinitas",viewAll:"Ver Todo",hotelsT:"Hoteles de Lujo",cruisesT:"Cruceros por el Nilo",perNight:"/ noche",aiTitle:"Constructor de Viajes IA",aiSub:"Describe tu viaje soñado — obtén un itinerario completo con precios reales",aiLabel:"✦ Cuéntanos tu viaje soñado a Egipto",aiBtn:"Crear Mi Itinerario →",aiThink:"Creando tu itinerario perfecto…",aiSend:"💬 Enviar y Reservar por WhatsApp",aiNew:"Nuevo Itinerario",whyTitle:"¿Por qué Golden Egypt Tours?",whySub:"El especialista más confiable de Egipto en el mundo",revTitle:"50.000+ Viajeros Felices",revSub:"Historias reales de aventureros reales",ctaTitle:"¿Listo para una Aventura Inolvidable?",ctaDesc:"Nuestros expertos en Egiptología crean tu viaje perfecto",bookNow:"Reservar Ahora",whatsapp:"WhatsApp",nlTitle:"Ofertas Exclusivas de Egipto",nlSub:"Únete a 200.000+ viajeros.",nlPh:"Tu correo electrónico",nlBtn:"Suscribirse",footerTag:"La plataforma de viajes de lujo de Egipto — viajes extraordinarios desde 2009.",pkgFrom:"Desde",pkgPerson:"/persona",pkgView:"Ver Paquete →",pkgTitle:"Paquetes de Viaje a Egipto",pkgSub:"Viajes Completos",exploreAll:"Explorar Todos los",packages:"Paquetes",},
  fr:{nav:{home:"Accueil",tours:"Tours",cruises:"Croisières Nil",hotels:"Hôtels",about:"À Propos",contact:"Contact"},heroTag:"Spécialistes N°1 de l'Égypte depuis 2009",title:"GOLDEN EGYPT",sub:"Tours & Expéditions",desc:"Cinq millénaires de merveilles — un voyage extraordinaire",searchPh:"Rechercher destinations, tours, expériences…",adv:"Recherche Avancée",checkin:"Arrivée",checkout:"Départ",guests:"Voyageurs",adults:"Adultes",children:"Enfants",tourType:"Type de Tour",searchBtn:"Rechercher Égypte",destTitle:"Explorer l'Égypte",destSub:"Dix destinations légendaires · Des histoires infinies",viewAll:"Voir Tout",hotelsT:"Hôtels de Luxe",cruisesT:"Croisières sur le Nil",perNight:"/ nuit",aiTitle:"Créateur d'Itinéraire IA",aiSub:"Décrivez votre voyage de rêve — obtenez un itinéraire complet avec prix réels",aiLabel:"✦ Décrivez votre voyage de rêve en Égypte",aiBtn:"Créer Mon Itinéraire →",aiThink:"Création de votre itinéraire parfait…",aiSend:"💬 Envoyer & Réserver par WhatsApp",aiNew:"Nouvel Itinéraire",whyTitle:"Pourquoi Golden Egypt Tours ?",whySub:"Le spécialiste le plus fiable de l'Égypte au monde",revTitle:"50 000+ Voyageurs Heureux",revSub:"Vraies histoires de vrais aventuriers",ctaTitle:"Prêt pour une Aventure Inoubliable ?",ctaDesc:"Nos experts égyptologues créent votre voyage parfait",bookNow:"Réserver",whatsapp:"WhatsApp",nlTitle:"Offres Exclusives Égypte",nlSub:"Rejoignez 200 000+ voyageurs.",nlPh:"Votre e-mail",nlBtn:"S'abonner",footerTag:"La plateforme de voyages de luxe en Égypte — des voyages extraordinaires depuis 2009.",pkgFrom:"À partir de",pkgPerson:"/personne",pkgView:"Voir Forfait →",pkgTitle:"Forfaits Voyage en Égypte",pkgSub:"Voyages Complets",exploreAll:"Explorer Tous les",packages:"Forfaits",},
  de:{nav:{home:"Startseite",tours:"Touren",cruises:"Nilkreuzfahrten",hotels:"Hotels",about:"Über Uns",contact:"Kontakt"},heroTag:"Ägyptens führende Reisespezialisten seit 2009",title:"GOLDEN EGYPT",sub:"Tours & Expeditionen",desc:"Fünf Jahrtausende Wunder — eine außergewöhnliche Reise",searchPh:"Ziele, Touren, Erlebnisse suchen…",adv:"Erweiterte Suche",checkin:"Check-in",checkout:"Check-out",guests:"Gäste",adults:"Erwachsene",children:"Kinder",tourType:"Tourtyp",searchBtn:"Ägypten Suchen",destTitle:"Ägypten Entdecken",destSub:"Zehn legendäre Ziele · Unendliche Geschichten",viewAll:"Alle anzeigen",hotelsT:"Luxushotels",cruisesT:"Nilkreuzfahrten",perNight:"/ Nacht",aiTitle:"KI-Reiseplaner",aiSub:"Beschreibe deine Traumreise — erhalte ein vollständiges Itinerar mit echten Preisen",aiLabel:"✦ Beschreibe deine Traumreise nach Ägypten",aiBtn:"Mein Itinerar Erstellen →",aiThink:"Dein perfektes Ägypten-Itinerar wird erstellt…",aiSend:"💬 Senden & Buchen per WhatsApp",aiNew:"Neues Itinerar",whyTitle:"Warum Golden Egypt Tours?",whySub:"Der vertrauenswürdigste Ägypten-Spezialist weltweit",revTitle:"50.000+ zufriedene Reisende",revSub:"Echte Geschichten echter Abenteurer",ctaTitle:"Bereit für ein unvergessliches Abenteuer?",ctaDesc:"Unsere Ägyptologen-Experten gestalten Ihre perfekte Reise",bookNow:"Jetzt Buchen",whatsapp:"WhatsApp",nlTitle:"Exklusive Ägypten-Angebote",nlSub:"Schließe dich 200.000+ Reisenden an.",nlPh:"Deine E-Mail",nlBtn:"Abonnieren",footerTag:"Ägyptens führende Luxusreiseplattform — außergewöhnliche Reisen seit 2009.",pkgFrom:"Ab",pkgPerson:"/Person",pkgView:"Paket Ansehen →",pkgTitle:"Ägypten Reisepakete",pkgSub:"Komplette Reisen",exploreAll:"Alle erkunden",packages:"Pakete",},
  it:{nav:{home:"Home",tours:"Tour",cruises:"Crociere Nilo",hotels:"Hotel",about:"Chi Siamo",contact:"Contatti"},heroTag:"Specialisti N°1 in Egitto dal 2009",title:"GOLDEN EGYPT",sub:"Tours & Expeditions",desc:"Cinque millenni di meraviglie — un viaggio straordinario",searchPh:"Cerca destinazioni, tour, esperienze…",adv:"Ricerca Avanzata",checkin:"Check-in",checkout:"Check-out",guests:"Ospiti",adults:"Adulti",children:"Bambini",tourType:"Tipo di Tour",searchBtn:"Cerca Egitto",destTitle:"Esplora l'Egitto",destSub:"Dieci destinazioni leggendarie · Storie infinite",viewAll:"Vedi Tutto",hotelsT:"Hotel di Lusso",cruisesT:"Crociere sul Nilo",perNight:"/ notte",aiTitle:"Creatore Itinerario IA",aiSub:"Descrivi il tuo viaggio dei sogni — ottieni un itinerario completo con prezzi reali",aiLabel:"✦ Descrivi il tuo viaggio dei sogni in Egitto",aiBtn:"Crea Il Mio Itinerario →",aiThink:"Creazione del tuo itinerario perfetto…",aiSend:"💬 Invia e Prenota su WhatsApp",aiNew:"Nuovo Itinerario",whyTitle:"Perché Golden Egypt Tours?",whySub:"Lo specialista più affidabile dell'Egitto nel mondo",revTitle:"50.000+ Viaggiatori Felici",revSub:"Storie vere da veri avventurieri",ctaTitle:"Pronto per un'Avventura Indimenticabile?",ctaDesc:"I nostri esperti egittologi creano il tuo viaggio perfetto",bookNow:"Prenota Ora",whatsapp:"WhatsApp",nlTitle:"Offerte Esclusive Egitto",nlSub:"Unisciti a 200.000+ viaggiatori.",nlPh:"La tua email",nlBtn:"Iscriviti",footerTag:"La piattaforma di viaggi di lusso in Egitto — viaggi straordinari dal 2009.",pkgFrom:"Da",pkgPerson:"/persona",pkgView:"Vedi Pacchetto →",pkgTitle:"Pacchetti Viaggio in Egitto",pkgSub:"Viaggi Completi",exploreAll:"Esplora Tutti i",packages:"Pacchetti",},
  pt:{nav:{home:"Início",tours:"Tours",cruises:"Cruzeiros Nilo",hotels:"Hotéis",about:"Sobre Nós",contact:"Contato"},heroTag:"Especialistas N°1 no Egito desde 2009",title:"GOLDEN EGYPT",sub:"Tours & Expeditions",desc:"Cinco milênios de maravilhas — uma jornada extraordinária",searchPh:"Pesquisar destinos, tours, experiências…",adv:"Pesquisa Avançada",checkin:"Check-in",checkout:"Check-out",guests:"Hóspedes",adults:"Adultos",children:"Crianças",tourType:"Tipo de Tour",searchBtn:"Pesquisar Egito",destTitle:"Explorar o Egito",destSub:"Dez destinos lendários · Histórias infinitas",viewAll:"Ver Tudo",hotelsT:"Hotéis de Luxo",cruisesT:"Cruzeiros no Nilo",perNight:"/ noite",aiTitle:"Criador de Itinerário IA",aiSub:"Descreva sua viagem dos sonhos — obtenha um itinerário completo com preços reais",aiLabel:"✦ Conte-nos sobre sua viagem dos sonhos no Egito",aiBtn:"Criar Meu Itinerário →",aiThink:"Criando seu itinerário perfeito…",aiSend:"💬 Enviar e Reservar pelo WhatsApp",aiNew:"Novo Itinerário",whyTitle:"Por que Golden Egypt Tours?",whySub:"O especialista mais confiável do Egito no mundo",revTitle:"50.000+ Viajantes Felizes",revSub:"Histórias reais de aventureiros reais",ctaTitle:"Pronto para uma Aventura Inesquecível?",ctaDesc:"Nossos especialistas em Egiptologia criam sua viagem perfeita",bookNow:"Reservar Agora",whatsapp:"WhatsApp",nlTitle:"Ofertas Exclusivas do Egito",nlSub:"Junte-se a 200.000+ viajantes.",nlPh:"Seu endereço de e-mail",nlBtn:"Inscrever-se",footerTag:"A plataforma de viagens de luxo do Egito — viagens extraordinárias desde 2009.",pkgFrom:"Desde",pkgPerson:"/pessoa",pkgView:"Ver Pacote →",pkgTitle:"Pacotes de Viagem ao Egito",pkgSub:"Viagens Completas",exploreAll:"Explorar Todos os",packages:"Pacotes",},
  ru:{nav:{home:"Главная",tours:"Туры",cruises:"Нил Круизы",hotels:"Отели",about:"О Нас",contact:"Контакты"},heroTag:"Специалисты №1 по Египту с 2009 года",title:"GOLDEN EGYPT",sub:"Туры и Экспедиции",desc:"Пять тысячелетий чудес — одно удивительное путешествие",searchPh:"Поиск направлений, туров, впечатлений…",adv:"Расширенный Поиск",checkin:"Заезд",checkout:"Выезд",guests:"Гости",adults:"Взрослые",children:"Дети",tourType:"Тип Тура",searchBtn:"Поиск Египет",destTitle:"Исследуйте Египет",destSub:"Десять легендарных направлений · Бесконечные истории",viewAll:"Смотреть всё",hotelsT:"Роскошные Отели",cruisesT:"Круизы по Нилу",perNight:"/ ночь",aiTitle:"ИИ Планировщик Путешествий",aiSub:"Опишите вашу мечту — получите полный маршрут с реальными ценами",aiLabel:"✦ Расскажите нам о вашем мечтаемом путешествии в Египет",aiBtn:"Создать Мой Маршрут →",aiThink:"Создаём ваш идеальный маршрут…",aiSend:"💬 Отправить и Забронировать в WhatsApp",aiNew:"Новый Маршрут",whyTitle:"Почему Golden Egypt Tours?",whySub:"Самый надёжный специалист по Египту в мире",revTitle:"50 000+ Довольных Путешественников",revSub:"Настоящие истории настоящих искателей приключений",ctaTitle:"Готовы к Незабываемому Приключению?",ctaDesc:"Наши эксперты-египтологи создадут ваше идеальное путешествие",bookNow:"Забронировать",whatsapp:"WhatsApp",nlTitle:"Эксклюзивные Предложения Египта",nlSub:"Присоединитесь к 200 000+ путешественников.",nlPh:"Ваш адрес электронной почты",nlBtn:"Подписаться",footerTag:"Ведущая платформа роскошных путешествий в Египет — с 2009 года.",pkgFrom:"От",pkgPerson:"/чел.",pkgView:"Смотреть Тур →",pkgTitle:"Туры в Египет",pkgSub:"Полные Маршруты",exploreAll:"Все",packages:"Туры",},
  zh:{nav:{home:"首页",tours:"旅游",cruises:"尼罗河游轮",hotels:"酒店",about:"关于我们",contact:"联系"},heroTag:"2009年以来埃及专业旅行社第一名",title:"黄金埃及",sub:"旅游与探险",desc:"五千年奇迹 — 一次非凡的旅程",searchPh:"搜索目的地、旅游、体验…",adv:"高级搜索",checkin:"入住",checkout:"退房",guests:"客人",adults:"成人",children:"儿童",tourType:"旅游类型",searchBtn:"搜索埃及",destTitle:"探索埃及",destSub:"十个传奇目的地 · 无限故事",viewAll:"查看全部",hotelsT:"豪华酒店",cruisesT:"尼罗河游轮",perNight:"/ 晚",aiTitle:"AI行程规划师",aiSub:"描述您的梦想埃及之旅 — 获得完整的每日行程和真实价格",aiLabel:"✦ 告诉我们您梦想的埃及之旅",aiBtn:"制定我的行程 →",aiThink:"正在制定您的完美行程…",aiSend:"💬 发送并通过WhatsApp预订",aiNew:"新行程",whyTitle:"为什么选择黄金埃及旅游？",whySub:"全球最值得信赖的埃及旅游专家",revTitle:"50,000+ 满意旅客",revSub:"真实旅行者的真实故事",ctaTitle:"准备好难忘的冒险了吗？",ctaDesc:"让我们的埃及学专家为您打造完美旅程",bookNow:"立即预订",whatsapp:"WhatsApp",nlTitle:"埃及独家优惠",nlSub:"加入200,000+旅客。",nlPh:"您的电子邮件地址",nlBtn:"订阅",footerTag:"埃及顶级豪华旅游平台 — 自2009年以来打造非凡旅程。",pkgFrom:"起价",pkgPerson:"/人",pkgView:"查看套餐 →",pkgTitle:"埃及旅游套餐",pkgSub:"完整行程",exploreAll:"探索所有",packages:"套餐",},
  nl:{nav:{home:"Home",tours:"Tours",cruises:"Nijlcruises",hotels:"Hotels",about:"Over Ons",contact:"Contact"},heroTag:"Egypte Specialisten N°1 sinds 2009",title:"GOLDEN EGYPT",sub:"Tours & Expedities",desc:"Vijf millennia van wonderen — één buitengewone reis",searchPh:"Zoek bestemmingen, tours, ervaringen…",adv:"Geavanceerd Zoeken",checkin:"Check-in",checkout:"Check-out",guests:"Gasten",adults:"Volwassenen",children:"Kinderen",tourType:"Tourtype",searchBtn:"Egypte Zoeken",destTitle:"Egypte Verkennen",destSub:"Tien legendarische bestemmingen · Oneindige verhalen",viewAll:"Alles Bekijken",hotelsT:"Luxe Hotels",cruisesT:"Nijlcruises",perNight:"/ nacht",aiTitle:"AI Reisplanner",aiSub:"Beschrijf uw droomreis — ontvang een volledig dag-voor-dag itinerair met echte prijzen",aiLabel:"✦ Vertel ons over uw droomreis naar Egypte",aiBtn:"Maak Mijn Reisplan →",aiThink:"Uw perfecte reisplan wordt gemaakt…",aiSend:"💬 Versturen & Boeken via WhatsApp",aiNew:"Nieuw Reisplan",whyTitle:"Waarom Golden Egypt Tours?",whySub:"De meest betrouwbare Egypte-specialist ter wereld",revTitle:"50.000+ Blije Reizigers",revSub:"Echte verhalen van echte avonturiers",ctaTitle:"Klaar voor een Onvergetelijk Avontuur?",ctaDesc:"Onze Egyptoloog-experts creëren uw perfecte reis",bookNow:"Nu Boeken",whatsapp:"WhatsApp",nlTitle:"Exclusieve Egypte Deals",nlSub:"Sluit je aan bij 200.000+ reizigers.",nlPh:"Uw e-mailadres",nlBtn:"Abonneren",footerTag:"Egypte's toonaangevende luxe reisplatform — buitengewone reizen sinds 2009.",pkgFrom:"Vanaf",pkgPerson:"/persoon",pkgView:"Pakket Bekijken →",pkgTitle:"Egypte Reispakketten",pkgSub:"Complete Reizen",exploreAll:"Alle",packages:"Pakketten",},
  ja:{nav:{home:"ホーム",tours:"ツアー",cruises:"ナイル川クルーズ",hotels:"ホテル",about:"会社情報",contact:"お問合せ"},heroTag:"2009年以来エジプト専門旅行社第1位",title:"ゴールデンエジプト",sub:"ツアー＆エクスペディション",desc:"五千年の驚異 — 一つの特別な旅",searchPh:"目的地、ツアー、体験を検索…",adv:"詳細検索",checkin:"チェックイン",checkout:"チェックアウト",guests:"ゲスト",adults:"大人",children:"子供",tourType:"ツアータイプ",searchBtn:"エジプトを検索",destTitle:"エジプトを探索",destSub:"10の伝説の目的地 · 無限の物語",viewAll:"すべて見る",hotelsT:"ラグジュアリーホテル",cruisesT:"ナイル川クルーズ",perNight:"/ 泊",aiTitle:"AIイティネラリービルダー",aiSub:"夢のエジプト旅行を説明してください — 実際の価格付きの完全な日程表を取得",aiLabel:"✦ エジプトへの夢の旅について教えてください",aiBtn:"旅程を作成 →",aiThink:"完璧な旅程を作成中…",aiSend:"💬 WhatsAppで送信・予約",aiNew:"新しい旅程",whyTitle:"なぜゴールデンエジプトツアーズ？",whySub:"世界で最も信頼されるエジプト専門家",revTitle:"50,000人以上の満足旅行者",revSub:"本物の旅行者の本物の物語",ctaTitle:"忘れられない冒険の準備はできていますか？",ctaDesc:"エジプト学の専門家があなたの完璧な旅を作ります",bookNow:"今すぐ予約",whatsapp:"WhatsApp",nlTitle:"エジプト限定特典",nlSub:"200,000人以上の旅行者に参加。",nlPh:"メールアドレス",nlBtn:"登録",footerTag:"エジプトのプレミアムラグジュアリー旅行プラットフォーム — 2009年から特別な旅を。",pkgFrom:"から",pkgPerson:"/人",pkgView:"パッケージを見る →",pkgTitle:"エジプト旅行パッケージ",pkgSub:"完全な旅程",exploreAll:"すべての",packages:"パッケージ",},
  he:{nav:{home:"דף הבית",tours:"סיורים",cruises:"שיטות על הנילוס",hotels:"מלונות",about:"אודות",contact:"צור קשר"},heroTag:"מומחי מצרים מספר 1 מאז 2009",title:"גולדן איגיפט",sub:"טורס ואקספדישנס",desc:"חמשת אלפי שנות פלא — מסע אחד יוצא דופן",searchPh:"חפש יעדים, סיורים, חוויות…",adv:"חיפוש מתקדם",checkin:"צ'ק אין",checkout:"צ'ק אאוט",guests:"אורחים",adults:"מבוגרים",children:"ילדים",tourType:"סוג סיור",searchBtn:"חפש במצרים",destTitle:"גלה את מצרים",destSub:"עשרה יעדים אגדיים · סיפורים אינסופיים",viewAll:"הצג הכל",hotelsT:"מלונות יוקרה",cruisesT:"שיטות על הנילוס",perNight:"/ לילה",aiTitle:"בונה מסלול AI",aiSub:"תאר את טיול החלומות שלך — קבל מסלול יומי מלא עם מחירים אמיתיים",aiLabel:"✦ ספר לנו על טיול מצרים שחלמת עליו",aiBtn:"בנה את המסלול שלי →",aiThink:"יוצר את המסלול המושלם שלך…",aiSend:"💬 שלח והזמן בוואטסאפ",aiNew:"מסלול חדש",whyTitle:"למה גולדן איגיפט טורס?",whySub:"מומחה מצרים המהימן ביותר בעולם",revTitle:"+50,000 נוסעים מרוצים",revSub:"סיפורים אמיתיים מאנשי הרפתקאות אמיתיים",ctaTitle:"מוכן להרפתקה בלתי נשכחת?",ctaDesc:"מומחי האגיפטולוגים שלנו יעצבו את המסע המושלם שלך",bookNow:"הזמן עכשיו",whatsapp:"וואטסאפ",nlTitle:"עסקאות בלעדיות למצרים",nlSub:"הצטרף ל-200,000+ נוסעים.",nlPh:"כתובת האימייל שלך",nlBtn:"הרשם",footerTag:"פלטפורמת הנסיעות היוקרתית של מצרים — מסעות יוצאי דופן מאז 2009.",pkgFrom:"מ-",pkgPerson:"/אדם",pkgView:"צפה בחבילה →",pkgTitle:"חבילות טיול למצרים",pkgSub:"מסעות מלאים",exploreAll:"גלה את כל",packages:"החבילות",},
};

// ─── DATA ─────────────────────────────────────────────────────
const CITIES = [
  {id:"cairo",      name:"Cairo",          nameAr:"القاهرة",      img:"/images/home/cairo.jpeg",    desc:"The Heart of Egypt",              tag:"Top Pick",   tours:120, color:"#C9A84C"},
  {id:"luxor",      name:"Luxor",          nameAr:"الأقصر",       img:"/images/home/luxor.jpeg",    desc:"World's Greatest Open Air Museum",tag:"Bestseller", tours:85,  color:"#E8A87C"},
  {id:"aswan",      name:"Aswan",          nameAr:"أسوان",        img:"/images/home/aswan.jpeg",    desc:"Jewel of the Nile",               tag:"Scenic",     tours:64,  color:"#7CB9E8"},
  {id:"hurghada",   name:"Hurghada",       nameAr:"الغردقة",      img:"/images/home/hurghada.jpeg", desc:"Red Sea Paradise",                tag:"Adventure",  tours:72,  color:"#52B788"},
...
const PACKAGES = [
  {title:"Nile Cruise: Luxor → Aswan",       subtitle:"5 Days · Floating Palace on the Nile",      img:"https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800&q=80",   badge:"Bestseller",   badgeColor:"#D4A847", price:650,  days:"5D/4N",  tags:["Nile Cruise","Temples","Full Board"],          link:"/packages"},
...
const S = {
  card:{
    background:"linear-gradient(145deg,rgba(20,17,30,.95),rgba(8,5,16,.98))",
  ...
  divider:{ height:1, background:"linear-gradient(to right,transparent,rgba(201,168,76,.35),transparent)", margin:"0 clamp(16px,4vw,48px)" },
};
...
body::before{
  ...
  background:
    radial-gradient(ellipse 100% 55% at 5% 10%,rgba(180,130,18,.08) 0%,transparent 55%),
...
.mq{display:flex;animation:marquee 30s linear infinite;white-space:nowrap;}.mq:hover{animation-play-state:paused;}
.ab::before{content:'';position:absolute;inset:-1px;border-radius:inherit;z-index:-1;background:linear-gradient(135deg,rgba(201,168,76,.6),rgba(201,168,76,.08),rgba(232,201,109,.5),rgba(201,168,76,.05),rgba(201,168,76,.6));background-size:400% 400%;animation:borderS 5s ease infinite;}

.cc{transition:all .45s cubic-bezier(.25,.8,.25,1)!important;}
.cc:hover{transform:translateY(-8px) scale(1.01)!important;box-shadow:0 28px 72px rgba(0,0,0,.7)!important;}
...
.hc{transition:all .38s ease!important;}
...
.hc:hover .hc-btn{background:rgba(201,168,76,.2)!important;border-color:rgba(201,168,76,.5)!important;}

.wc:hover{transform:translateY(-6px)!important;border-color:rgba(201,168,76,.5)!important;box-shadow:0 24px 60px rgba(0,0,0,.55)!important;}
...
.pkgc:hover{transform:translateY(-10px) scale(1.01)!important;border-color:rgba(201,168,76,.45)!important;box-shadow:0 36px 90px rgba(0,0,0,.7)!important;}
.pkgc:hover .pkgi{transform:scale(1.08)!important;}

.btn-gold{background:linear-gradient(135deg,var(--g),var(--gl));color:#050309;border:none;border-radius:10px;padding:13px 28px;cursor:pointer;font-weight:700;font-size:11px;letter-spacing:2.5px;text-transform:uppercase;font-family:'Josefin Sans',sans-serif;box-shadow:0 6px 28px rgba(201,168,76,.42);transition:all .25s;}
.btn-gold:hover{box-shadow:0 10px 40px rgba(201,168,76,.6);transform:translateY(-2px);}
.btn-ghost{background:transparent;border:1px solid rgba(201,168,76,.3);color:var(--g);border-radius:9px;padding:9px 22px;cursor:pointer;font-size:10px;letter-spacing:2.5px;text-transform:uppercase;font-family:'Josefin Sans',sans-serif;transition:all .2s;white-space:nowrap;}
.btn-ghost:hover{background:rgba(201,168,76,.1);border-color:rgba(201,168,76,.55);}
...
.ai-feat:hover{background:rgba(201,168,76,.08)!important;padding-left:18px!important;}
...
function CityCard({c,navigate,large}){
  ...
  return(
    <div className="cc" onClick={()=>navigate(`/city/${c.id}`)}
      ...
      <div className="ctag" style={{position:"absolute",top:12,left:12,background:`${color}1E`,border:`1px solid ${color}55`,borderRadius:24,padding:"3px 12px",fontSize:9,fontWeight:700,color:color,letterSpacing:1.5,textTransform:"uppercase",backdropFilter:"blur(10px)",fontFamily:"'Josefin Sans',sans-serif",opacity:hov?1:.85,transition:"opacity .3s"}}>{c.tag}</div>
      <div style={{position:"absolute",top:12,right:12,background:"rgba(5,3,9,.7)",border:"1px solid rgba(201,168,76,.2)",borderRadius:7,padding:"2px 9px",fontSize:8,color:"rgba(201,168,76,.7)",backdropFilter:"blur(8px)",fontFamily:"'Josefin Sans',sans-serif"}}>{c.tours} tours</div>
      <div style={{position:"absolute",bottom:0,left:0,right:0,padding:"14px 16px"}}>
        <div style={{fontFamily:"'Cormorant Garamond',serif",fontStyle:"italic",fontSize:11,color:"rgba(237,232,217,.4)",marginBottom:5,opacity:hov?1:0,transition:"opacity .3s"}}>{c.desc}</div>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
          <div style={{fontFamily:"'Cinzel',serif",fontWeight:600,fontSize:large?"clamp(17px,2vw,24px)":"clamp(12px,1.3vw,16px)",color:"#fff",marginBottom:0,textShadow:"0 2px 16px rgba(0,0,0,.9)"}}>{c.name}</div>
          ...
          {step===3?(
            ...
            <>
              <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:22}}>
                {[1,2].map(s=>(<div key={s} style={{display:"flex",alignItems:"center",gap:8}}><div style={{width:28,height:28,borderRadius:"50%",background:step>=s?"linear-gradient(135deg,var(--g),var(--gl))":"rgba(201,168,76,.1)",border:step>=s?"none":"1px solid rgba(201,168,76,.2)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:11,fontWeight:700,color:step>=s?"#050309":"var(--g)",transition:"all .3s"}}>{s}</div>{s<2&&<div style={{width:40,height:1,background:`linear-gradient(to right,${step>=2?"rgba(201,168,76,.5)":"rgba(201,168,76,.15)"},transparent)`}}/>}</div>))}
              ...
              {step===1&&(
                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:13,animation:"fadeIn .3s ease"}}>
                  <div style={{gridColumn:"1/-1"}}><label style={{fontSize:9,color:"var(--g)",letterSpacing:2,textTransform:"uppercase",display:"block",marginBottom:7,fontFamily:"'Josefin Sans',sans-serif"}}>Full Name *</label><input value={f.name} onChange={upd("name")} placeholder="Your full name" style={inp} onFocus={fi} onBlur={fo}/></div>
                  <div><label style={{fontSize:9,color:"var(--g)",letterSpacing:2,textTransform:"uppercase",display:"block",marginBottom:7,fontFamily:"'Josefin Sans',sans-serif"}}>Age</label><input value={f.age} onChange={upd("age")} placeholder="Your age" type="number" min="1" style={inp} onFocus={fi} onBlur={fo}/></div>
                  <div><label style={{fontSize:9,color:"var(--g)",letterSpacing:2,textTransform:"uppercase",display:"block",marginBottom:7,fontFamily:"'Josefin Sans',sans-serif"}}>Nationality</label><input value={f.nationality} onChange={upd("nationality")} placeholder="e.g. American" style={inp} onFocus={fi} onBlur={fo}/></div>
                  <div style={{gridColumn:"1/-1"}}><label style={{fontSize:9,color:"var(--g)",letterSpacing:2,textTransform:"uppercase",display:"block",marginBottom:7,fontFamily:"'Josefin Sans',sans-serif"}}>Guide Language *</label><select value={f.guideLang} onChange={upd("guideLang")} style={{...inp,cursor:"pointer"}} onFocus={fi} onBlur={fo}>{GUIDE_LANGS.map(o=><option key={o.v} value={o.v} style={{background:"#14111E"}}>{o.l}</option>)}</select></div>
                  <div style={{gridColumn:"1/-1"}}><label style={{fontSize:9,color:"var(--g)",letterSpacing:2,textTransform:"uppercase",display:"block",marginBottom:7,fontFamily:"'Josefin Sans',sans-serif"}}>Payment Currency</label><select value={f.currency} onChange={upd("currency")} style={{...inp,cursor:"pointer"}} onFocus={fi} onBlur={fo}>{Object.entries(CURR).map(([code,{l}])=><option key={code} value={code} style={{background:"#14111E"}}>{l}</option>)}</select></div>
                  <div><label style={{fontSize:9,color:"var(--g)",letterSpacing:2,textTransform:"uppercase",display:"block",marginBottom:7,fontFamily:"'Josefin Sans',sans-serif"}}>WhatsApp * 📱</label><input value={f.whatsapp} onChange={upd("whatsapp")} placeholder="+1 234 567 8900" type="tel" style={inp} onFocus={fi} onBlur={fo}/></div>
                  <div><label style={{fontSize:9,color:"var(--g)",letterSpacing:2,textTransform:"uppercase",display:"block",marginBottom:7,fontFamily:"'Josefin Sans',sans-serif"}}>Email *</label><input value={f.email} onChange={upd("email")} placeholder="your@email.com" type="email" style={inp} onFocus={fi} onBlur={fo}/></div>
                  <div style={{gridColumn:"1/-1",marginTop:6}}><button onClick={()=>setStep(2)} disabled={!ok1} style={{width:"100%",background:"linear-gradient(135deg,var(--g),var(--gl))",color:"#050309",border:"none",borderRadius:12,padding:"14px",cursor:"pointer",fontWeight:700,fontSize:12,letterSpacing:2.5,textTransform:"uppercase",fontFamily:"'Josefin Sans',sans-serif",boxShadow:"0 6px 28px rgba(201,168,76,.4)",opacity:!ok1?.45:1,transition:"all .25s"}}>Next — Trip Details →</button></div>
                </div>
              )}
              {step===2&&(
                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:13,animation:"fadeIn .3s ease"}}>
                  <div><label style={{fontSize:9,color:"var(--g)",letterSpacing:2,textTransform:"uppercase",display:"block",marginBottom:7,fontFamily:"'Josefin Sans',sans-serif"}}>Tour Date *</label><input value={f.date} onChange={upd("date")} type="date" style={{...inp,colorScheme:"dark"}} onFocus={fi} onBlur={fo}/></div>
                  <div><label style={{fontSize:9,color:"var(--g)",letterSpacing:2,textTransform:"uppercase",display:"block",marginBottom:7,fontFamily:"'Josefin Sans',sans-serif"}}>Number of Guests</label><input value={f.guests} onChange={upd("guests")} type="number" min="1" placeholder="2" style={inp} onFocus={fi} onBlur={fo}/></div>
                  <div style={{gridColumn:"1/-1"}}><label style={{fontSize:9,color:"var(--g)",letterSpacing:2,textTransform:"uppercase",display:"block",marginBottom:7,fontFamily:"'Josefin Sans',sans-serif"}}>Pick-up Location * 📍</label><input value={f.pickup} onChange={upd("pickup")} placeholder="Hotel name / address / city" style={inp} onFocus={fi} onBlur={fo}/></div>
          ...
          <div style={{position:"relative"}} className="dn">
            ...
            {lO&&<div style={{position:"absolute",top:"calc(100%+8px)",right:0,background:"#14111E",border:"1px solid rgba(201,168,76,.22)",borderRadius:12,overflow:"hidden",minWidth:185,zIndex:2000,boxShadow:"0 24px 60px rgba(0,0,0,.8)",animation:"slideD .2s ease",maxHeight:340,overflowY:"auto"}}>
              {Object.entries(LANGS).map(([code,info])=>(
                <div key={code} className="dd" onClick={()=>{setLang(code);setLO(false);}} style={{padding:"10px 16px",cursor:"pointer",fontSize:12,color:lang===code?"var(--g)":"var(--dim)",transition:"all .15s",display:"flex",alignItems:"center",gap:8,fontWeight:lang===code?700:400}}>{info.flag} {info.label}</div>
              ))}
            </div>}
          </div>
          {/* Currency */}
          <div style={{position:"relative"}} className="dn">
            ...
            {cO&&<div style={{position:"absolute",top:"calc(100%+8px)",right:0,background:"#14111E",border:"1px solid rgba(201,168,76,.22)",borderRadius:12,overflow:"hidden",minWidth:215,zIndex:2000,boxShadow:"0 24px 60px rgba(0,0,0,.8)",animation:"slideD .2s ease",maxHeight:320,overflowY:"auto"}}>
              {Object.entries(CURR).map(([code,{l}])=>(
                <div key={code} className="dd" onClick={()=>{setCur(code);setCO(false);}} style={{padding:"10px 16px",cursor:"pointer",fontSize:11,color:cur===code?"var(--g)":"var(--dim)",transition:"all .15s",fontWeight:cur===code?700:400}}>{l}</div>
              ))}
            </div>}
          </div>
          <button onClick={()=>setBookItem({title:"General Enquiry"})} className="dn btn-gold" style={{whiteSpace:"nowrap"}}>{t.bookNow}</button>
          <button className="dm" style={{display:"none",background:"rgba(201,168,76,.1)",border:"1px solid rgba(201,168,76,.25)",color:"var(--g)",width:40,height:40,borderRadius:8,cursor:"pointer",fontSize:16,alignItems:"center",justifyContent:"center"}} onClick={()=>setMMenu(!mMenu)}>{mMenu?"✕":"☰"}</button>
        </div>
      </nav>
      ...
      <section style={{position:"relative",height:"100vh",minHeight:640,maxHeight:1000,overflow:"hidden",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"}}>
        ...
        <div style={{position:"absolute",bottom:"clamp(158px,20vh,210px)",left:"clamp(20px,5vw,56px)",zIndex:5}} key={slide}>
          <div style={{display:"flex",alignItems:"center",gap:8,background:"rgba(5,3,9,.7)",backdropFilter:"blur(12px)",border:"1px solid rgba(201,168,76,.2)",borderRadius:10,padding:"7px 14px",animation:"fadeIn .8s ease"}}>
            ...
            <span style={{width:1,height:10,background:"rgba(201,168,76,.3)",margin:"0 4px"}}/>
            <span style={{fontFamily:"'Cormorant Garamond',serif",fontStyle:"italic",fontSize:12,color:"rgba(237,232,217,.45)"}}>{HERO[slide].title}</span>
          </div>
        </div>
        ...
        <div style={{position:"relative",zIndex:4,textAlign:"center",padding:"0 clamp(16px,5vw,64px)",width:"100%",maxWidth:980,animation:"fadeUp .9s ease both"}}>
          ...
          <div style={{display:"flex",gap:14,justifyContent:"center",flexWrap:"wrap",opacity:0,animation:"fadeUp .9s ease .4s forwards"}}>
            ...
            <a href="https://wa.me/201068257754" target="_blank" rel="noreferrer" style={{background:"rgba(37,211,102,.1)",border:"1px solid rgba(37,211,102,.35)",color:"#25D366",borderRadius:10,padding:"13px 24px",textDecoration:"none",fontWeight:700,fontSize:11,letterSpacing:2,fontFamily:"'Josefin Sans',sans-serif",display:"flex",alignItems:"center",gap:8,transition:"all .25s"}}>💬 {t.whatsapp}</a>
          </div>
        </div>
        ...
        <div style={{position:"relative",zIndex:5,width:"min(960px,94vw)",opacity:0,animation:"fadeUp .9s ease .48s forwards",marginTop:32}}>
          <div style={{background:"rgba(5,3,9,.87)",backdropFilter:"blur(30px)",border:"1px solid rgba(201,168,76,.3)",borderRadius:24,padding:"clamp(16px,3vw,26px)",boxShadow:"0 36px 100px rgba(0,0,0,.72),inset 0 1px 0 rgba(201,168,76,.18)"}}>
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:15}}>
              ...
              <button onClick={()=>setAdv(!adv)} style={{background:adv?"rgba(201,168,76,.15)":"transparent",border:"1px solid rgba(201,168,76,.25)",color:adv?"var(--g)":"rgba(201,168,76,.5)",borderRadius:7,padding:"4px 14px",cursor:"pointer",fontSize:10,letterSpacing:1,transition:"all .2s"}}>{t.adv} {adv?"▲":"▾"}</button>
            </div>
            <div style={{position:"relative",marginBottom:14}}>
              <span style={{position:"absolute",left:15,top:"50%",transform:"translateY(-50%)",color:"rgba(201,168,76,.45)",fontSize:17}}>🔍</span>
              <input value={q} onChange={e=>setQ(e.target.value)} placeholder={t.searchPh} style={{...iS,paddingLeft:46,paddingRight:44,fontSize:15}} onFocus={fi} onBlur={fo}/>
            ...
            {res.length>0&&(
              <div style={{background:"rgba(11,9,20,.98)",border:"1px solid rgba(201,168,76,.22)",borderRadius:14,marginBottom:14,overflow:"hidden",maxHeight:360,overflowY:"auto",animation:"slideD .2s ease"}}>
                {res.map((r,i)=>(
                  <div key={i} className="si" onClick={()=>{navigate(r.url);setQ("");setRes([]);setAdv(false);}} style={{display:"flex",alignItems:"center",gap:13,padding:"12px 16px",cursor:"pointer",borderBottom:"1px solid rgba(201,168,76,.06)",transition:"background .15s"}}>
                    ...
                    <div style={{background:r.color?`${r.color}18`:"rgba(201,168,76,.1)",border:`1px solid ${r.color||"rgba(201,168,76,.22)"}`,borderRadius:6,padding:"2px 10px",fontSize:9,color:r.color||"var(--g)",letterSpacing:1,textTransform:"uppercase",flexShrink:0}}>{r.tag}</div>
                  </div>
                ))}
              </div>
            )}
            {q&&!res.length&&<div style={{padding:"14px 16px",textAlign:"center",fontFamily:"'Cormorant Garamond',serif",fontStyle:"italic",fontSize:14,color:"var(--muted)"}}>No results for "{q}" — try "Luxor", "Pyramids", "cruise"…</div>}
            {adv&&(
              <div className="sg" style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr 1.2fr auto",gap:11,animation:"fadeUp .3s ease"}}>
                {[{label:t.checkin,type:"date"},{label:t.checkout,type:"date"}].map((f,i)=>(
                  <div key={i} style={{display:"flex",flexDirection:"column",gap:5}}>
                    <span style={{fontSize:9,color:"var(--muted)",letterSpacing:2,textTransform:"uppercase"}}>{f.label}</span>
                    <input type={f.type} style={{...iS,colorScheme:"dark"}} onFocus={fi} onBlur={fo}/>
                  </div>
                ))}
                <div style={{display:"flex",flexDirection:"column",gap:5,position:"relative"}}>
                  <span style={{fontSize:9,color:"var(--muted)",letterSpacing:2,textTransform:"uppercase"}}>👥 {t.guests}</span>
                ...
                <div style={{display:"flex",flexDirection:"column",gap:5}}>
                  <span style={{fontSize:9,color:"var(--muted)",letterSpacing:2,textTransform:"uppercase"}}>🗺 {t.tourType}</span>
                  <select style={{...iS,cursor:"pointer"}} onFocus={fi} onBlur={fo}>
                    {["All Types","Day Tour","Nile Cruise","Multi-Day","Adventure","Cultural","Private","Honeymoon","Family"].map(o=><option key={o} style={{background:"#14111E"}}>{o}</option>)}
                  </select>
                </div>
                <button onClick={()=>{if(res.length)navigate(res[0].url);else navigate("/tours");}} className="btn-gold" style={{alignSelf:"flex-end",padding:"11px 18px",fontSize:11}}>🔍 {t.searchBtn}</button>
              </div>
            )}
          </div>
        </div>
...
<VideoPreview />
        ...
        <div className="statg" style={{maxWidth:1060,margin:"0 auto",display:"grid",gridTemplateColumns:"repeat(4,1fr)",padding:"clamp(18px,3vw,26px) clamp(16px,4vw,40px)"}}>
          {[["50K+","Happy Travelers","🧳"],["200+","Curated Tours","🗺️"],["4.9★","Avg Rating","⭐"],["15+","Years of Excellence","🏆"]].map(([n,l,ic],i)=>(
            <div key={i} data-v={`st${i}`} style={{textAlign:"center",borderRight:i<3?"1px solid rgba(201,168,76,.1)":"none",padding:"0 16px",opacity:vis[`st${i}`]?1:0,transform:vis[`st${i}`]?"none":"translateY(18px)",transition:`opacity .65s ease ${i*.1}s,transform .65s ease ${i*.1}s`}}>
              ...
              <div style={{fontSize:9,color:"rgba(201,168,76,.45)",letterSpacing:2,textTransform:"uppercase",marginTop:4}}>{l}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      <section style={S.section}>
        <div {...rv("dh")} style={{...S.sectionHeader,...rv("dh").style}}>
          <div style={S.sectionTitleWrap}>
            <span style={S.sectionEyebrow}>✦ {t.destSub}</span>
            <h2 style={S.sectionTitle}>{t.destTitle}</h2>
          </div>
          <button onClick={()=>navigate("/tours")} className="btn-ghost">{t.viewAll} →</button>
        </div>
      ...
      <section style={S.section}>
        <div {...rv("ph")} style={{...S.sectionHeader,...rv("ph").style}}>
          <div style={S.sectionTitleWrap}>
            <span style={S.sectionEyebrow}>✦ {t.pkgSub}</span>
            <h2 style={S.sectionTitle}>🗺️ {t.pkgTitle}</h2>
          </div>
              ...
              <div style={S.cardBody}>
                ...
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                  <div>
                    ...
                    <span style={{fontFamily:"'Cinzel',serif",color:"var(--g)",fontSize:"clamp(18px,2vw,24px)",fontWeight:700}}>{fmtP(p.price)}</span>
                    <span style={{color:"var(--muted)",fontSize:10}}>{t.pkgPerson}</span>
                  </div>
                  <button onClick={e=>{e.stopPropagation();navigate(p.link);}} style={{background:"rgba(201,168,76,.1)",border:"1px solid rgba(201,168,76,.28)",color:"var(--g)",borderRadius:10,padding:"8px 18px",cursor:"pointer",fontSize:10,letterSpacing:1.5,textTransform:"uppercase",transition:"all .2s"}}>
                    {t.pkgView.split(" ")[0]} →
                  </button>
                </div>
              </div>
        ...
        <div className="g2" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"clamp(28px,5vw,64px)"}}>
          ...
          <div {...rv("ht")} style={{...rv("ht").style}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"baseline",marginBottom:24}}>
              <div>
                <div style={{fontSize:9,color:"var(--g)",letterSpacing:4,textTransform:"uppercase",marginBottom:6,fontWeight:700}}>𓇳 Accommodation</div>
                <h2 style={{fontFamily:"'Cinzel',serif",fontSize:"clamp(18px,2.2vw,30px)",fontWeight:700}}>🏨 {t.hotelsT}</h2>
              </div>
              <button onClick={()=>navigate("/hotels")} style={{background:"none",border:"none",color:"var(--g)",cursor:"pointer",fontSize:10,letterSpacing:2,textTransform:"uppercase"}}>{t.viewAll} →</button>
            </div>
            <div className="g4" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:14}}>
              {HOTELS.map((h,i)=>(
                <div key={i} className="hc" style={{...S.card,cursor:"pointer"}}>
                  <div style={{position:"relative",height:120,overflow:"hidden"}}>
                    <img src={h.img} alt={h.name} style={{width:"100%",height:"100%",objectFit:"cover",transition:"transform .55s ease",display:"block"}} onError={e=>e.target.src=`https://placehold.co/400x120/14111E/C9A84C?text=${h.name.slice(0,8)}`}/>
                    ...
                    <div style={{position:"absolute",bottom:9,left:11,right:11,display:"flex",justifyContent:"space-between",alignItems:"flex-end"}}>
                      <span style={{background:"rgba(201,168,76,.9)",color:"#050309",fontSize:8,fontWeight:800,padding:"2px 8px",borderRadius:10,letterSpacing:1}}>{h.city}</span>
                      <Stars n={h.stars}/>
                    </div>
                  </div>
                  <div style={{padding:"11px 14px 14px"}}>
                    ...
                    <div style={{display:"flex",alignItems:"baseline",gap:4,marginBottom:10}}>
                      <span style={{fontFamily:"'Cormorant Garamond',serif",fontSize:19,fontWeight:700,color:"var(--g)"}}>{fmtP(h.price)}</span>
                      <span style={{fontSize:10,color:"var(--muted)"}}>{t.perNight}</span>
                    </div>
                    <button className="hc-btn" onClick={()=>setBookItem(h)} style={{width:"100%",background:"rgba(201,168,76,.1)",border:"1px solid rgba(201,168,76,.22)",color:"var(--g)",borderRadius:8,padding:"7px",cursor:"pointer",fontSize:10,letterSpacing:1.5,textTransform:"uppercase",transition:"all .2s"}}>Book →</button>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div {...rv("cr")} style={{...rv("cr").style}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"baseline",marginBottom:24}}>
              <div>
                <div style={{fontSize:9,color:"var(--g)",letterSpacing:4,textTransform:"uppercase",marginBottom:6,fontWeight:700}}>⛴ River Journeys</div>
                <h2 style={{fontFamily:"'Cinzel',serif",fontSize:"clamp(18px,2.2vw,30px)",fontWeight:700}}>🚢 {t.cruisesT}</h2>
              </div>
              <button onClick={()=>navigate("/cruises")} style={{background:"none",border:"none",color:"var(--g)",cursor:"pointer",fontSize:10,letterSpacing:2,textTransform:"uppercase"}}>{t.viewAll} →</button>
            </div>
            <div className="g4" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:14}}>
              {CRUISES.map((cr,i)=>(
                <div key={i} className="hc" style={{...S.card,cursor:"pointer"}}>
                  <div style={{position:"relative",height:120,overflow:"hidden"}}>
                    <img src={cr.img} alt={cr.name} style={{width:"100%",height:"100%",objectFit:"cover",transition:"transform .55s ease",display:"block"}} onError={e=>e.target.src=`https://placehold.co/400x120/14111E/C9A84C?text=${cr.name.slice(0,8)}`}/>
                    <div style={{position:"absolute",inset:0,background:"linear-gradient(to top,rgba(5,3,9,.88),transparent 55%)"}}/>
                    <div style={{position:"absolute",top:8,left:10,background:"rgba(201,168,76,.15)",border:"1px solid rgba(201,168,76,.3)",borderRadius:6,padding:"2px 9px",fontSize:8,color:"var(--g)",letterSpacing:1,backdropFilter:"blur(8px)"}}>{cr.route}</div>
                  ...
                  <div style={{padding:"11px 14px 14px"}}>
                    ...
                    <div style={{display:"flex",alignItems:"baseline",gap:4,marginBottom:10}}>
                      <span style={{fontFamily:"'Cormorant Garamond',serif",fontSize:19,fontWeight:700,color:"var(--g)"}}>{fmtP(cr.price)}</span>
                      <span style={{fontSize:10,color:"var(--muted)"}}>{t.perNight}</span>
                    </div>
                    <button className="hc-btn" onClick={()=>setBookItem(cr)} style={{width:"100%",background:"rgba(201,168,76,.1)",border:"1px solid rgba(201,168,76,.22)",color:"var(--g)",borderRadius:8,padding:"7px",cursor:"pointer",fontSize:10,letterSpacing:1.5,textTransform:"uppercase",transition:"all .2s"}}>Book →</button>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section id="ai-sec" style={S.section}>
        <div {...rv("ai")} style={{...rv("ai").style}}>
          <div style={{textAlign:"center",marginBottom:"clamp(28px,4vw,52px)"}}>
            <div style={{fontSize:9,color:"var(--g)",letterSpacing:5,textTransform:"uppercase",marginBottom:10,fontWeight:700}}>🤖 AI-Powered Planning</div>
          ...
          <div className="aig" style={{display:"grid",gridTemplateColumns:"1fr 1.5fr",gap:32,maxWidth:1100,margin:"0 auto",alignItems:"start"}}>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:14}}>
              <div style={{background:"linear-gradient(135deg,rgba(201,168,76,.08),rgba(201,168,76,.03))",border:"1px solid rgba(201,168,76,.18)",borderRadius:20,padding:"28px 24px"}}>
                <div style={{fontSize:44,textAlign:"center",marginBottom:14,animation:"float 4s ease-in-out infinite"}}>𓂀</div>
                <div style={{fontFamily:"'Cinzel',serif",fontSize:15,fontWeight:700,color:"var(--g)",textAlign:"center",marginBottom:6}}>Smart Egypt AI</div>
                <div style={{fontFamily:"'Cormorant Garamond',serif",fontStyle:"italic",fontSize:13,color:"var(--muted)",textAlign:"center",marginBottom:20,lineHeight:1.6}}>Powered by Claude AI — the world's most capable travel planning assistant</div>
                {[
                  ...
                  <div key={i} className="ai-feat" style={{display:"flex",alignItems:"center",gap:12,padding:"9px 12px",borderRadius:10,border:"1px solid transparent",marginBottom:5,transition:"all .25s",cursor:"default"}}>
                    <span style={{fontSize:20,flexShrink:0}}>{f.icon}</span>
                    <div>
                      <div style={{fontSize:11,fontWeight:700,color:"var(--text)",letterSpacing:.5}}>{f.label}</div>
                      <div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:12,color:"var(--muted)",marginTop:1}}>{f.desc}</div>
                    </div>
                    <span style={{marginLeft:"auto",color:"rgba(201,168,76,.4)",fontSize:11}}>✓</span>
                  </div>
                ))}
              </div>
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}}>
                {[["🔒","Secure","Bank-grade"],["⚡","Instant","In seconds"],["🌍","11 Langs","Multilingual"],["💯","Free","No cost"]].map(([ic,t2,d],i)=>(
                  <div key={i} style={{background:"rgba(201,168,76,.05)",border:"1px solid rgba(201,168,76,.12)",borderRadius:12,padding:"12px",textAlign:"center"}}>
                    <div style={{fontSize:20,marginBottom:4}}>{ic}</div>
                    <div style={{fontSize:10,fontWeight:700,color:"var(--g)",letterSpacing:1}}>{t2}</div>
                    <div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:11,color:"var(--muted)",marginTop:2}}>{d}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="ab" style={{borderRadius:22,position:"relative"}}>
              <div style={{background:"linear-gradient(145deg,rgba(20,17,30,.99),rgba(5,3,9,.99))",borderRadius:22,padding:"clamp(24px,4vw,44px)",position:"relative",overflow:"hidden"}}>
                ...
                <button onClick={buildAI} disabled={aiLoad||!aiQ.trim()}
                  style={{width:"100%",background:"linear-gradient(135deg,var(--g),var(--gl))",color:"#050309",border:"none",borderRadius:13,padding:"17px",cursor:aiLoad?"wait":"pointer",fontWeight:700,fontSize:14,letterSpacing:3,textTransform:"uppercase",boxShadow:"0 8px 36px rgba(201,168,76,.45)",transition:"all .25s",opacity:(aiLoad||!aiQ.trim())?.5:1,display:"flex",alignItems:"center",justifyContent:"center",gap:12}}>
                  {aiLoad
                    ?<><div style={{width:18,height:18,border:"2px solid rgba(0,0,0,.2)",borderTop:"2px solid #050309",borderRadius:"50%",animation:"spin .7s linear infinite"}}/>{t.aiThink}</>
                    :`🤖 ${t.aiBtn}`
                  }
                </button>
                ...
                {aiDone&&(
                  <div style={{marginTop:16,display:"flex",gap:12,flexWrap:"wrap",animation:"fadeUp .5s ease"}}>
                    <button onClick={()=>window.open("https://wa.me/201068257754","_blank")}
                      style={{flex:1,background:"#25D366",color:"#fff",border:"none",borderRadius:11,padding:"13px 20px",cursor:"pointer",fontWeight:700,fontSize:13,letterSpacing:1.5,display:"flex",alignItems:"center",justifyContent:"center",gap:8}}>
                      {t.aiSend}
                    </button>
                    <button onClick={()=>{setAiQ("");setAiRes("");setAiDone(false);}}
                      style={{background:"rgba(255,255,255,.05)",border:"1px solid rgba(255,255,255,.1)",color:"var(--muted)",borderRadius:11,padding:"13px 20px",cursor:"pointer",fontSize:13}}>
                      {t.aiNew}
                    </button>
                  </div>
                )}
      ...
      <section style={S.section}>
        <div {...rv("hw")} style={{maxWidth:860,margin:"0 auto",...rv("hw").style}}>
          <div style={{textAlign:"center",marginBottom:40}}>
            <div style={{fontSize:9,color:"var(--g)",letterSpacing:5,textTransform:"uppercase",marginBottom:10,fontWeight:700}}>✦ Simple Process</div>
      ...
      <section style={S.section}>
        <div {...rv("wh")} style={{textAlign:"center",marginBottom:"clamp(28px,4vw,52px)",...rv("wh").style}}>
          <div style={{fontSize:9,color:"var(--g)",letterSpacing:5,textTransform:"uppercase",marginBottom:10,fontWeight:700}}>✦ Our Promise</div>
        ...
        <div className="whyg" style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:16,maxWidth:1100,margin:"0 auto"}}>
          {WHY.map((w,i)=>(
            <div key={i} data-v={`wy${i}`} className="wc" style={{...S.card,padding:"clamp(18px,2.5vw,28px)",cursor:"default",position:"relative",overflow:"hidden",opacity:vis[`wy${i}`]?1:0,transform:vis[`wy${i}`]?"none":"translateY(24px)",transition:`opacity .7s ease ${i*.07}s,transform .7s ease ${i*.07}s,all .35s`}}>
      ...
      <section style={S.section}>
        <div {...rv("rh")} style={{textAlign:"center",marginBottom:"clamp(28px,4vw,48px)",...rv("rh").style}}>
          <div style={{fontSize:9,color:"var(--g)",letterSpacing:5,textTransform:"uppercase",marginBottom:10,fontWeight:700}}>⭐ Testimonials</div>
        ...
        <div className="revg" style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:15,maxWidth:1100,margin:"0 auto"}}>
          {REVIEWS.map((r,i)=>(
            <div key={i} data-v={`rv${i}`} className="rc" style={{...S.card,padding:"clamp(16px,2.5vw,24px)",position:"relative",opacity:vis[`rv${i}`]?1:0,transform:vis[`rv${i}`]?"none":"translateY(24px)",transition:`opacity .7s ease ${i*.08}s,transform .7s ease ${i*.08}s,all .33s`}}>
      ...
      <div style={{margin:"0 clamp(16px,4vw,48px) clamp(52px,8vw,100px)",borderRadius:22,overflow:"hidden",position:"relative"}}>
        ...
        {["𓂀","𓅓","𓇋"].map((h,i)=>(
          <div key={i} style={{position:"absolute",fontSize:60,color:"rgba(201,168,76,.04)",fontFamily:"serif",left:`${[10,50,82][i]}%`,top:`${[20,60,25][i]}%`,pointerEvents:"none",animation:`float ${5+i}s ease-in-out infinite`,animationDelay:`${i*.8}s`}}>{h}</div>
        ))}
        <div {...rv("cta")} style={{position:"relative",padding:"clamp(40px,6vw,84px) clamp(24px,6vw,84px)",textAlign:"center",...rv("cta").style}}>
          <div style={{fontSize:9,color:"var(--g)",letterSpacing:5,textTransform:"uppercase",marginBottom:16,fontWeight:700}}>✦ Start Your Journey</div>
          <h2 style={{fontFamily:"'Cinzel',serif",fontSize:"clamp(22px,4.5vw,54px)",fontWeight:700,marginBottom:14,color:"#fff",lineHeight:1.1}}>
            <span className="gt">{t.ctaTitle}</span>
          </h2>
          ...
          <div style={{display:"flex",gap:14,justifyContent:"center",flexWrap:"wrap"}}>
            <button onClick={()=>setBookItem({title:"Book Your Egypt Adventure"})} className="btn-gold" style={{padding:"15px 38px",fontSize:13}}>✈ {t.bookNow}</button>
            <a href="https://wa.me/201068257754" target="_blank" rel="noreferrer" style={{background:"rgba(37,211,102,.12)",border:"1px solid rgba(37,211,102,.4)",color:"#25D366",borderRadius:12,padding:"15px 28px",textDecoration:"none",fontWeight:700,fontSize:13,letterSpacing:1.5,display:"flex",alignItems:"center",gap:8,transition:"all .25s"}}>
              💬 {t.whatsapp}
            </a>
          </div>
        </div>
      ...
      <section style={{background:"rgba(19,16,29,.6)",borderTop:"1px solid rgba(201,168,76,.1)",borderBottom:"1px solid rgba(201,168,76,.1)",padding:"clamp(36px,5vw,64px) clamp(16px,4vw,48px)",textAlign:"center"}}>
        <div {...rv("nl")} style={{maxWidth:480,margin:"0 auto",...rv("nl").style}}>
          <div style={{fontSize:9,color:"var(--g)",letterSpacing:5,textTransform:"uppercase",marginBottom:10,fontWeight:700}}>✉ Newsletter</div>
          ...
          {!subOk
            ?<div style={{display:"flex",gap:10}}>
              ...
              <button onClick={()=>email&&setSubOk(true)} className="btn-gold" style={{whiteSpace:"nowrap",padding:"12px 22px",fontSize:11}}>{t.nlBtn}</button>
            </div>
        ...
        <div className="ftg" style={{display:"grid",gridTemplateColumns:"2fr 1fr 1fr 1.5fr",gap:"clamp(24px,4vw,52px)",marginBottom:"clamp(28px,4vw,48px)"}}>
          <div>
            ...
            <div style={{display:"flex",gap:8}}>
              {[["f","FB"],["📸","IG"],["𝕏","X"],["▶","YT"]].map(([ic,nm])=>(
                <a key={nm} href="#" title={nm} style={{width:34,height:34,borderRadius:8,background:"rgba(201,168,76,.07)",border:"1px solid rgba(201,168,76,.14)",display:"flex",alignItems:"center",justifyContent:"center",color:"var(--muted)",textDecoration:"none",fontSize:12,transition:"all .2s"}}>{ic}</a>
              ))}
            </div>
          </div>
          {[
            ...
            <div key={col.t}>
              <div style={{color:"var(--g)",fontSize:9,letterSpacing:3,textTransform:"uppercase",marginBottom:16,fontWeight:700,paddingBottom:10,borderBottom:"1px solid rgba(201,168,76,.1)"}}>{col.t}</div>
              {col.l.map(lnk=>(
                <a key={lnk} href="#" style={{display:"block",color:"var(--muted)",fontSize:13,marginBottom:9,textDecoration:"none",transition:"color .2s",fontFamily:"'Cormorant Garamond',serif",lineHeight:1.4}}
                  onMouseOver={e=>e.target.style.color="var(--g)"} onMouseOut={e=>e.target.style.color="var(--muted)"}>{lnk}</a>
              ))}
            </div>
          ))}
          <div>
            <div style={{color:"var(--g)",fontSize:9,letterSpacing:3,textTransform:"uppercase",marginBottom:16,fontWeight:700,paddingBottom:10,borderBottom:"1px solid rgba(201,168,76,.1)"}}>Contact</div>
            ...
            <div style={{marginTop:14}}>
              <div style={{color:"var(--g)",fontSize:9,letterSpacing:2,textTransform:"uppercase",marginBottom:10,fontWeight:700}}>Legal</div>
              {["Privacy Policy","Terms of Service","Cookie Policy","FAQ"].map(l=>(
                <a key={l} href="#" style={{display:"block",color:"var(--muted)",fontSize:12,marginBottom:8,textDecoration:"none",transition:"color .2s",fontFamily:"'Cormorant Garamond',serif"}}
                  onMouseOver={e=>e.target.style.color="var(--g)"} onMouseOut={e=>e.target.style.color="var(--muted)"}>{l}</a>
              ))}
            </div>
          </div>
        </div>
        <div style={{borderTop:"1px solid rgba(201,168,76,.07)",paddingTop:"clamp(16px,3vw,22px)",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:12}}>
          ...
          <div style={{display:"flex",gap:8}}>
            {["🔒 SSL","✈ IATA","🌍 UNWTO"].map(b=>(
              <span key={b} style={{background:"rgba(201,168,76,.05)",border:"1px solid rgba(201,168,76,.1)",borderRadius:6,padding:"3px 10px",color:"#4A3A2A",fontSize:9,letterSpacing:1}}>{b}</span>
            ))}
          </div>
        </div>
      </footer>
      ...
      <a href="https://wa.me/201068257754" target="_blank" rel="noreferrer"
        style={{position:"fixed",bottom:76,right:20,background:"#25D366",color:"#fff",borderRadius:30,padding:"11px 18px",textDecoration:"none",fontWeight:700,fontSize:12,letterSpacing:1,display:"flex",alignItems:"center",gap:8,zIndex:500,boxShadow:"0 6px 28px rgba(37,211,102,.48)",transition:"all .25s"}}>
        💬 <span>{t.whatsapp}</span>
      </a>
      <button onClick={()=>window.scrollTo({top:0,behavior:"smooth"})}
        style={{position:"fixed",bottom:20,right:20,width:46,height:46,borderRadius:12,background:"rgba(201,168,76,.12)",border:"1px solid rgba(201,168,76,.3)",color:"var(--g)",fontSize:16,cursor:"pointer",zIndex:500,display:"flex",alignItems:"center",justifyContent:"center",transition:"all .25s",boxShadow:"0 4px 18px rgba(0,0,0,.45)"}}>▲</button>
